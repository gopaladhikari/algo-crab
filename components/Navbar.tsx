      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex md:order-2">
          <Link
            href={"/login"}
            type="button"
            className="text-white transition-colors bg-blue-700 hover:bg-blue-800  font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-700 dark:hover:bg-blue-700/80 dark:focus:ring-blue-800"
          >
            Sign in / Sign up
          </Link>
          <button
