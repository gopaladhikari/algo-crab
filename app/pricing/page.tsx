        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
            <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
              Choose Your Best Affordable Pricing plan
            </h2>
            <p className="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">
              Our subscription is based on the strategy. We have 8 Strategies
              which price varry from 999 to 2999 INR. You can get the price
            ...
            {pricingList.map(({ id, title, description, price, features }) => (
              ...
              >
                ...
                <div className="flex justify-center items-baseline my-8">
                  <span className="mr-2 mb-auto">INR</span>
