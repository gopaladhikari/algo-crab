            ...
            >
              <div>
                ...
                {errors.name && touched.name && (
                  <p className="text-[red] ms-2 mt-2"> {errors.name} </p>
                )}
              </div>
              <div>
                <label
                ...
                {errors.email && touched.email && (
                  <p className="text-[red] ms-2 mt-2"> {errors.email} </p>
                )}
              </div>
              <div>
                <label
                ...
                {errors.password && touched.password && (
                  <p className="text-[red] ms-2 mt-2"> {errors.password} </p>
                )}
              </div>
              <div>
                <label
                ...
                {errors.confirm_password && touched.confirm_password && (
                  <p className="text-[red] ms-2 mt-2">
